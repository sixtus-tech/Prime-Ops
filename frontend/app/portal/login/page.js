      ...
      <div className="w-full max-w-md mx-4">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          ...
          <p className="text-gray-500 text-sm mb-6">
            Sign in with your KingsChat account to view your committees and tasks.
          </p>
          ...
          <div className="mt-6 pt-4 border-t border-gray-100 text-center">
            <Link href="/admin/login" className="text-sm text-gray-500 hover:text-gray-700">
              Project Director? <span className="text-blue-600 font-medium">Go to Director Console →</span>
            </Link>
          </div>
        </div>
      </div>
